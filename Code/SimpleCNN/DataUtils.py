...
def dump_data(filePath, index_list):
    ...
    with open(filePath + '/dataSimpleCNN.json', 'w') as f:
        json.dump(data_map, f)
    with open(filePath + '/heightSimpleCNN.json', 'w') as f:
...
def create_dataset(data_folder):
    ...
    '''
    with open(data_folder + '/dataSimpleCNN.json', 'r') as f:
