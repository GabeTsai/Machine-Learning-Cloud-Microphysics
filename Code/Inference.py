...
def create_test_dataset_nc(data_file_path, model_name, model_folder_path, data_name):
...
def main():
    model_name = 'MLP3'
    dataset_name = 'dycoms'
    data_file_path = f'../Data/NetCDFFiles/{dataset_name}_stats.nc'
    ...
    inputs, targets = create_test_dataset_nc(data_file_path, model_name, model_folder_path, dataset_name)

    log_targets = destandardize_output(model_folder_path, model_name, targets)
    ...
    calc_eq(true_values, model_folder_path, model_name)
    # if denorm_log_pred:
