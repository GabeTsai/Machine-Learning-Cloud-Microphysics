...
class VariableLSTM(nn.Module):
    ...
    def forward(self, x, lengths):
        '''
        :param x: (batch, seq_len, num_features).
        :param lengths: sequence lengths, must be on cpu.
        '''
        ...
        # Select output of last time step of last layer
        idx = (torch.arange(output.size(0)), lengths - 1) #batch dimension indices, zero-based seq indices
        out = output[idx]
