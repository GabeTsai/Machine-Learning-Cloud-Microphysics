...
import sys
sys.path.append('../../')
from DataUtils import prepare_datasets, standardize
...
def concat_data(data_maps, model_name, model_folder_path, data_name = ''):
    ...
    dims = (0)
    input_data = standardize(input_data, dims)
    ...
    test_target_data = target_data[train_size:]
